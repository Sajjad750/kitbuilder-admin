...
function Dashboard() {
  const {infoData,isAuthenticated} = useSelector(state => state.admin)
          ...
          <Grid item xs={12} md={6} lg={3}>
            <MDBox mb={1.5}>
              <ComplexStatisticsCard
                ...
                icon="weekend"
                title="Quotations"
                count={infoData && infoData.quotations}
                percentage={{
                  color: "success",
                  amount: "+55%",
          ...
          <Grid item xs={12} md={6} lg={3}>
            <MDBox mb={1.5}>
              <ComplexStatisticsCard
                icon="leaderboard"
                title="Retailers"
                count={infoData && infoData.retailers}
                percentage={{
                  color: "success",
                  amount: "+3%",
          ...
          <Grid item xs={12} md={6} lg={3}>
            <MDBox mb={1.5}>
              <ComplexStatisticsCard
                ...
                icon="store"
                title="Categories"
                count={infoData && infoData.categories}
                percentage={{
                  color: "success",
                  amount: "+1%",
          ...
          <Grid item xs={12} md={6} lg={3}>
            <MDBox mb={1.5}>
              <ComplexStatisticsCard
                ...
                icon="store"
                title="Products"
                count={infoData && infoData.products}
                percentage={{
                  color: "success",
                  amount: "+1%",
                  label: "than yesterday",
